...
def _visualize_regions(ax: np.ndarray, df: pd.DataFrame, title: str) -> None:
...
def visualize_regions_grid(
    ...
    for idx, (mcs, df_copy) in enumerate(evals):
        ...
        _visualize_regions(ax, df_copy, title=f"min_cluster_size={mcs}")
